...
Route::middleware(['auth'])->group(function () {
    ...
    // RT routes
    Route::get('/rt/kas-bulanan/{record}/preview', [KasBulananRTController::class, 'preview'])->name('rt.kas-bulanan.preview');
    Route::get('/rt/kas-bulanan/{record}/download', [KasBulananRTController::class, 'download'])->name('rt.kas-bulanan.download');
    Route::get('/rt/kas-tahunan/{tahun}/preview', [KasBulananRTController::class, 'previewTahunan'])->name('rt.kas-tahunan.preview');
    Route::get('/rt/kas-tahunan/{tahun}/download', [KasBulananRTController::class, 'downloadTahunan'])->name('rt.kas-tahunan.download');
