...
<head>
    ...
    <title>Preview Laporan Kas Bulanan RW {{ $rw->nomor_rw }} - Periode {{ $record->periode }}</title>
...
<body>
    ...
    <div class="action-bar">
        ...
        <a href="{{ route('rw.kas-bulanan.download', $record) }}" class="btn-export">
    ...
    <div class="paper">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="info-value">RW {{ $rw->nomor_rw }}</span>
            </div>
            <div class="info-item">
                <span class="info-label">Nama Ketua RW</span>
                <span class="info-value">{{ $rw->nama ?? '-' }}</span>
            </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding-left: 30px;">• Total Pendapatan Kas Harian (Rw)</td>
                    <td class="text-right text-success">+ Rp {{ number_format($totalPendapatanKasHarian, 0, ',', '.') }}</td>
                </tr>
                <tr>
                    <td style="padding-left: 30px;">• Total Pemasukan Setoran dari RT</td>
                ...
                <tr>
                    <td style="padding-left: 30px;">• Total Pengeluaran Kas Harian (Rw)</td>
                    <td class="text-right text-danger">- Rp {{ number_format($totalPengeluaranKasHarian, 0, ',', '.') }}</td>
                </tr>
                <tr>
                    <td style="padding-left: 30px;">• Total Pengeluaran Gaji Petugas</td>
