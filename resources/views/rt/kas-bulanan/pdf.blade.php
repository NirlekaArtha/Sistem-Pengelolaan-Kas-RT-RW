...
<head>
    <meta charset="UTF-8">
    <title>Laporan Kas Bulanan RT {{ $rt->nomor_rt }} - Periode {{ $record->periode }}</title>
    <style>
        body {
...
<body>
    ...
    <table class="info-table">
        <tr>
            ...
            <td class="info-label">Ketua RT</td>
            <td class="info-colon">:</td>
            <td>{{ $rt->nama ?? '-' }}</td>
        </tr>
        <tr>
    ...
    <table class="report-table">
        ...
        <tbody>
            ...
            <tr>
                <td style="padding-left: 20px;">• Total Pendapatan Kas Harian (RT)</td>
                <td class="text-right text-success">+ Rp {{ number_format($totalPendapatanKasHarian, 0, ',', '.') }}</td>
            </tr>
            <tr>
                <td style="padding-left: 20px;">• Total Pendapatan Iuran Warga</td>
            ...
            <tr>
                <td style="padding-left: 20px;">• Total Pengeluaran Kas Harian (RT)</td>
                <td class="text-right text-danger">- Rp {{ number_format($totalPengeluaranKasHarian, 0, ',', '.') }}</td>
            </tr>
            <tr>
                <td style="padding-left: 20px;">• Total Pengeluaran Setoran ke RW</td>
