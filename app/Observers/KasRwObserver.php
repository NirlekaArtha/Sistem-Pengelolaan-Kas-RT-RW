...
class KasRwObserver
{
     ...
     * Recalculate KasBulananRW for the period of the new entry.
     */
    public function created(KasRW $kasRW): void
    {
        $periode = $kasRW->tanggal->format("Y-m");
        KasBulananRwService::recalculate($kasRW->id_rw, $periode);
    }

    /**
     * Handle the KasRW "updated" event.
     * If tanggal or id_rw changed, also recalculate the OLD period/RW.
     */
     ...
     * Recalculate KasBulananRW for the period the deleted entry belonged to.
     */
